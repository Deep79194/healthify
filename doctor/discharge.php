...
<body>
    ...
    <div class="container-fluid">
        <div class="col-md-12">
            <div class="row">
                <div class="row-md-2" style="margin-left: -30px;">
                <?php
                    include("sidenav.php");
                ?>
                </div>
                <div class="col-md-10">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <table class="table table-bordered">
                                <tr>
                                    <td colspan="2" class="text-center">Appointment Details
                                    </td>
                    ...
                    ?>
                                ...
                                <form method="post">
                                    <label>Fees</label>
                                    <input type="number" name="fee" class="form-control" autocomplete="off" placeholder="Enter fees">
