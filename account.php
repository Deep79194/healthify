<?php 
	...
	if(isset($_POST['create'])){
		...
		if(count($error)==0)
	{
			$query="INSERT INTO patient(firstname,surname,username,email,phone,gender,password,date_reg,profile) VALUES('$fname','$name','$uname','$email','$phone','$gender','$password',NOW(),'patient.jpeg')";
